            ...
            <section className="ftco-section ftco-cart">
                <div className="container">
                    <div className="row justify-content-center">
                        ...
                        <button type="button" className="btn btn-primary py-3 px-5" onClick={login}>
                            Login to Continue
                        </button>
                        </div>
                    </div>
                        ...
                        <div className="border-end bg-white" id="sidebar-wrapper">
                            <div className="list-group list-group-flush">
                                <a className="list-group-item list-group-item-action list-group-item-light p-3"
                                    onClick={() => setShowFile(true)}>Your Infor</a>
                                <a className="list-group-item list-group-item-action list-group-item-light p-3"
                                    onClick={() => setShowFile(false)}>Your Orders</a>
                                <a className="list-group-item list-group-item-action list-group-item-light p-3"
                                    ...
                                    showFile? (
                                        ...
                                        <ul className="nav nav-tabs">
                                            <li className="nav-item" onClick={() => {
                                                ...
                                                <a className={waitConfirm===1?'nav-link active':'nav-link'} href="#">Chờ xử lý</a>
                                            </li>
                                            <li className="nav-item" onClick={() => {
                                                setWaitConfirm(2)
                                                setStatus('Đang giao hàng')
                                            }}>
                                                <a className={waitConfirm===2?'nav-link active':'nav-link'} href="#">Đang giao hàng</a>
                                            </li>
                                            <li className="nav-item" onClick={() => {
                                                setWaitConfirm(3)
                                                setStatus('Đã giao hàng')
                                            }}>
                                                <a className={waitConfirm===3?'nav-link active':'nav-link'} href="#">Đã giao hàng</a>
                                            </li>
                                            <li className="nav-item" onClick={() => {
                                                setWaitConfirm(4)
                                                setStatus('Hủy đơn hàng')
                                            }}>
                                                <a className={waitConfirm===4?'nav-link active':'nav-link'} href="#">Hủy đơn hàng</a>
                                            </li>
                                        </ul>
                                    )
                                }
                                                ...
                                                arrOrder.map(item => {
                                                    ...
                                                    return (
                                                        <div>
                                                                    ...
                                                                    return (
                                                                        <ul>
                                                                            <li className="header__cart-item" style={{padding:'0', marginTop:'1rem'}} key={index}>
                                                                                <img src={order.img.img_1} alt="" style={{width:'10%'}}/>
                                                                                <div className="d-flex flex-column" style={{width:'100%'}}>
                                                                                    <div className="header__cart-item-info d-flex justify-content-between" style={{width:'100%'}}>
                                                                                        ...
                                                                                        <div>
                                                                                            <h5>{currencyFormat(order.img.price)}</h5>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div>
                                                                                        <h5 className="header__cart-item-name" style={{paddingLeft:'1rem'}}>
                                                            ...
                                                            <div className="d-flex justify-content-end">
                                                                <h5 style={{padding: '1rem', backgroundColor: '#e29481'}}>
