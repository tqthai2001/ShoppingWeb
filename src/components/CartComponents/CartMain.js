                        ...
                        {cart.map((product, index) => (
                          <tr className='text-center' key={index}>
                              ...
                              <span>
                                ...
                                >
                                  {(close) => (
                                    <div>
                                      <div
                                        className='modal-header text-uppercase'
                                        style={{
                                          background: "#ffc107",
                                        }}
                                      >
                            ...
                            <td className='price'>
                              {currencyFormat(
                                parseInt(
                                  product.price - (product.price * sale) / 100,
                                  10
                                )
                              )}
                            </td>
              ...
              <div className='row justify-content-end'>
                <div className='col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate'>
                  <div className='cart-total mb-3'>
                    ...
                    <p className='d-flex'>
                      <span>Subtotal</span>
                      <span>{currencyFormat(parseInt(totalCost, 10))}</span>
                    </p>
                    <p className='d-flex'>
                      <span>Delivery</span>
                      <span>$0.00</span>
